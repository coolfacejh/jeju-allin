...
const ko: Dict = {
  ...
  'home.clean.desc': '입력한 취향과 장소 태그를 비교합니다. 평점·시설 검증을 뜻하지 않습니다.',
  ...
  'onb.q4': '관심 테마',
  'onb.food': '식단 · 회피음식',
  'onb.food.desc': '등록된 식단 정보를 기준으로 찾습니다. 알레르기·교차오염 여부는 매장에 확인해 주세요.',
  'onb.required': '필수',
  'onb.optional': '선택',
  'onb.cta': '취향 분석하고 맞춤 추천받기',
  'onb.trust': '로그인 없이 이 브라우저에 저장됩니다. 브라우저 데이터를 지우면 삭제됩니다',
...
const en: Dict = {
  ...
  'home.clean.desc': 'Ranked by your preferences and place tags, not verified ratings or facilities.',
